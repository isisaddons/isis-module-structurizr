 ...
 *  under the License.
 */
package org.isisaddons.module.structurizr.webapp;
 ...
 * 
 */
public class StructurizrModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "Structurizr Module Example App";
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                // bind(AppManifest.class).toInstance(new StructurizrAppAppManifest());
            }
        };
