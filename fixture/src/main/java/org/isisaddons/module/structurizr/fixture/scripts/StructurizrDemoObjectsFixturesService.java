 ...
 *  under the License.
 */
package org.isisaddons.module.structurizr.fixture.scripts;
...
public class StructurizrDemoObjectsFixturesService extends FixtureScripts {

    public StructurizrDemoObjectsFixturesService() {
        super(StructurizrDemoObjectsFixturesService.class.getPackage().getName());
    }
    ...
    public Object installFixturesAndReturnFirst() {
        final FixtureScript script = findFixtureScriptFor(StructurizrDemoObjectsFixture.class);
